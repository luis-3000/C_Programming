...
// Tells the compiler to replace MYNAME with what is provided "Jose L. Castillo"

#define MYNAME "Jose L Castillo"
...
main()
{
	...
	// In C, to create a String you instead create char arrays
	// Every char array has a '\0' String Terminator as the last 
	// character, so always make your char arrays at least 1
	// character longer than you need
	
	char myName[17] = "Jose L Castillo";
	
	// You could also do this char myName[] = "Jose L. Castillo";
	...
	// You can only accept more then one value if you
	...
	// You can also accept a "/" if you know the user will enter it
	
	int month, day, year;
	
	printf("Whats your birth date (mm/dd/yy)? ");
